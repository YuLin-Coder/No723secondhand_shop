        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-3 col-sm-6">
                <div class="single-products">
                    <div class="product-img">
                        <a href="toProductDetail?gid=${data.id}">
                            <img src="/images/${data.photo}" style="width: 300px;height: 350px;" alt="Image">
                        </a>
                    </div>
                    <div class="product-content">
                        <a href="toProductDetail?gid=${data.id}" class="title">
                            ${data.goodsname}
                        </a>
            ...
            <div class="col-12">
                <div class="pagination-area text-center">
                    ...
                    <a class="page-numbers " href="toSearchProduct?currentPage=1">首页</a>
                    <c:if test="${pageInfo.hasPreviousPage }">
                        <a  class="page-numbers" href="toSearchProduct?currentPage=${pageInfo.pageNum-1}">&lt;&lt;</a>
                    </c:if>

                    <c:forEach begin="${pageInfo.pageNum  }"  end="${pageInfo.pages }" var="i">
                        <a  class="page-numbers  <c:if test="${pageInfo.pageNum == i }">current </c:if> " href="toSearchProduct?currentPage=${i }"     >${i }</a>
                    </c:forEach>
                    <c:if test="${pageInfo.hasNextPage }">
                        <a  class="page-numbers" href="toSearchProduct?currentPage=${pageInfo.pageNum+1}">&gt;&gt;</a>
                    </c:if>
                    <a class="page-numbers " href="toSearchProduct?currentPage=${pageInfo.pages}">尾页</a>
