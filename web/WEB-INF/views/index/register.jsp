                ...
                <form id="saveForm">
                    <div class="billing-details">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    <label>班级</label> <input type="text" name="bj"
                                                             class="form-control">
                                </div>
                            </div>

                            <div class="form-group">
                                <label>密码</label> <input type="password" name="pwd" v
                                                         class="form-control">
                            </div>
                            ...
                            <div class="submit-box">
                                <button type="button" id="save" class="btn btn-primary">确定注册</button>
                            </div>
