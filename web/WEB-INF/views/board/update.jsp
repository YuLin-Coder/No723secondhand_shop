				...
				<main>
					<div class="main">
								...
								<div class="col-5">
									...
									<input type="hidden" name="id" value="${data.id }">
										<div class="form-group">
											<label>主题</label> <input type="text" name="title" value="${data.title }"
																	 class="form-control"> <small
												class="form-text text-muted"></small>
										</div>

										<div class="form-group">
											<label>内容</label> <input type="text" name="content" value="${data.content }"
																	 class="form-control"> <small
												class="form-text text-muted"></small>
										</div>
						...
						<div class="submit-box">
							...
							<a type="button" href="BoardList" class="btn btn-outline-secondary">返回</a>
		...
		$("#save").click(function() {
			$.ajax({
				...
				success : function(e) {
					if (e) {
						alert("修改成功！");
						window.parent.location.href = "BoardList";
					} else {
						alert("修改失败！");
					}
				}
