		...
		<main>
			...
			<div id="body">
				<main>
					<div class="main">
						<div class="search">
							<form class="form-inline float-left" action="StudentList"
								method="post">
										...
										<tr>
											...
											<td>${data.registe_time }</td>
                                             <td><img src="/images/${data.photo}" id="preview_img" style="width:50px; height:50px; "></td>											<td><input id="${data.id}" value="${data.id}"
												...
												href="toUpdateStudent?id=${data.id }">修改</a> <a  class="btn btn-danger btn-sm del" 
 ...
 -->
							<ul class="pagination">
								<li class="page-item"><a class="page-link"
									href="StudentList?currentPage=1">首页</a></li>
								<c:if test="${pageInfo.hasPreviousPage }">
									<li class="page-item"><a class="page-link"
										href="StudentList?currentPage=${pageInfo.pageNum-1}">&lt;&lt;</a></li>
								</c:if>

						        <c:forEach begin="${pageInfo.pageNum  }"  end="${pageInfo.pages }" var="i">
                                        <li class="page-item"><a class="page-link" href="StudentList?currentPage=${i }">${i }</a></li>
                                </c:forEach>
								...
								<li class="page-item"><a class="page-link"
									href="StudentList?currentPage=${pageInfo.pages}">尾页</a></li>
