		...
		<main>
			...
			<div id="body">
				<main>
					<div class="main">
						<div class="search">
							<form class="form-inline float-left" action="GoodsList"
								method="post">
								<div class="form-group">
									<input type="text" name="key" value="${key}"
										class="form-control" placeholder="物品名称">
								</div>
										...
										<tr>
											...
											<td>${data.create_time }</td>
                                             <td><img src="/images/${data.photo}" id="preview_img" style="width:50px; height:50px; "></td>											<td><input id="${data.id}" value="${data.id}"
												...
												href="toUpdateGoods?id=${data.id }">修改</a> <a  class="btn btn-danger btn-sm del" 
 ...
 -->
							<ul class="pagination">
								<li class="page-item"><a class="page-link"
									href="GoodsList?currentPage=1">首页</a></li>
								<c:if test="${pageInfo.hasPreviousPage }">
									<li class="page-item"><a class="page-link"
										href="GoodsList?currentPage=${pageInfo.pageNum-1}">&lt;&lt;</a></li>
								</c:if>

						        <c:forEach begin="${pageInfo.pageNum  }"  end="${pageInfo.pages }" var="i">
                                        <li class="page-item"><a class="page-link" href="GoodsList?currentPage=${i }">${i }</a></li>
                                </c:forEach>
								...
								<li class="page-item"><a class="page-link"
									href="GoodsList?currentPage=${pageInfo.pages}">尾页</a></li>
