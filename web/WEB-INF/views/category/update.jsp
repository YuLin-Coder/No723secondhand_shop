				...
				<main>
					<div class="main">
								...
								<div class="col-5">
									...
									<input type="hidden" name="id" value="${data.id }">
										<div class="form-group">
											<label>分类名称</label> <input type="text" name="name" value="${data.name }"
										...
										<div class="form-group">
											<label>备注</label> <textarea type="text" name="note"
																		class="form-control">${data.note }</textarea> <small
												class="form-text text-muted"></small>
										</div>
									</form>
								</div>
						...
						<div class="submit-box">
							...
							<a type="button" href="CategoryList" class="btn btn-outline-secondary">返回</a>
