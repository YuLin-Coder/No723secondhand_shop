		...
		<main>
			...
			<div id="body">
				<main>
					<div class="main">
						<div class="search">
							<form class="form-inline float-left" action="CategoryList"
								method="post">
									...
									<c:forEach items="${pageInfo.list}" var="data">
										<tr>
									       ...
									       <td><input id="${data.id}" value="${data.id}"
												...
												href="toUpdateCategory?id=${data.id }">修改</a> <a  class="btn btn-danger btn-sm del" 
 ...
 -->
							<ul class="pagination">
								...
								<c:if test="${pageInfo.hasPreviousPage }">
									<li class="page-item"><a class="page-link"
										href="CategoryList?currentPage=${pageInfo.pageNum-1}">&lt;&lt;</a></li>
								</c:if>

						        <c:forEach begin="${pageInfo.pageNum  }"  end="${pageInfo.pages }" var="i">
                                        <li class="page-item"><a class="page-link" href="CategoryList?currentPage=${i }">${i }</a></li>
                                </c:forEach>
								...
								<li class="page-item"><a class="page-link"
									href="CategoryList?currentPage=${pageInfo.pages}">尾页</a></li>
