		...
		<main>
			...
			<div id="body">
				<main>
					<div class="main">
						<div class="search">
							<form class="form-inline float-left" action="ProductList"
								method="post">
								<div class="form-group">
									<input type="text" name="key" value="${key}"
										class="form-control" placeholder="失物名称">
								</div>
						...
						<div class="table-box">
							...
							<table class="table">
								<thead>
									<tr>
										<th scope="col">失物名称</th>
										<th scope="col">物品状态</th>
										<th scope="col">发布者姓名</th>
										<th scope="col">联系方式</th>
										<th scope="col">捡到/丢失日期</th>
										<th scope="col">备注</th>
										...
										<tr>
											...
											<td>${data.create_time }</td>
                                             <td><img src="/images/${data.photo}" id="preview_img" style="width:50px; height:50px; "></td>											<td><input id="${data.id}" value="${data.id}"
												...
												href="toUpdateProduct?id=${data.id }">修改</a> <a  class="btn btn-danger btn-sm del" 
 ...
 -->
							<ul class="pagination">
								<li class="page-item"><a class="page-link"
									href="ProductList?currentPage=1">首页</a></li>
								<c:if test="${pageInfo.hasPreviousPage }">
									<li class="page-item"><a class="page-link"
										href="ProductList?currentPage=${pageInfo.pageNum-1}">&lt;&lt;</a></li>
								</c:if>

						        <c:forEach begin="${pageInfo.pageNum  }"  end="${pageInfo.pages }" var="i">
                                        <li class="page-item"><a class="page-link" href="ProductList?currentPage=${i }">${i }</a></li>
                                </c:forEach>
								...
								<li class="page-item"><a class="page-link"
									href="ProductList?currentPage=${pageInfo.pages}">尾页</a></li>
