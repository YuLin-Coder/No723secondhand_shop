				...
				<main>
					<div class="main">
								...
								<div class="col-5">
									...
									<input type="hidden" name="id" value="${data.id }">
										...
										<div class="form-group">
											<label>物品名称</label> <input type="text" name="goodsname" value="${data.goodsname }"
										...
										<div class="form-group">
											...
											<option value="丢失物品"  <c:if test="${data.type == '丢失物品'}">selected</c:if>>丢失物品</option>
											<option value="捡到物品"  <c:if test="${data.type == '捡到物品'}">selected</c:if>>捡到物品</option>
										...
										<div class="form-group">
											<label>发布者姓名</label> <input type="text" name="publisher" value="${data.publisher }"
																		class="form-control"> <small
												class="form-text text-muted"></small>
										</div>

										<div class="form-group">
											<label>发生地点</label> <input type="text" name="phone" value="${data.phone }"
																	   class="form-control"> <small
												class="form-text text-muted"></small>
										</div>

										<div class="form-group">
											<label>联系方式</label> <input type="text" name="spot" value="${data.spot }"
																	   class="form-control"> <small
												class="form-text text-muted"></small>
										</div>
										...
										<div class="form-group">
											<label>失物简介</label> <input type="text" name="note" value="${data.note }"
																	   class="form-control"> <small
												class="form-text text-muted"></small>
										</div>
										...
										<div class="form-group">
											<label>捡到/丢失日期</label> <input type="text" name="create_date" value="${data.create_date }"
													  class="form-control"> <small
												class="form-text text-muted"></small>
										</div>
						...
						<div class="submit-box">
							...
							<a type="button" href="ProductList" class="btn btn-outline-secondary">返回</a>
